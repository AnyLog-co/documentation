...
A more thorough set of documentation regarding querying the Blockchain / Metadata can be found [here]().
...
A more thorough set of documentation regarding querying the SQL can be found [here]().