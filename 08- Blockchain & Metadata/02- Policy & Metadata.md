...
* [Mapping Policy]() - A mapping policy defines how incoming JSON data (arriving at an operator node) should be
...
* [UNS]() - Unified namespace policies are a way to help the user view the data in a hierarchical format; similar to
