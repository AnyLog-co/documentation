...
* <a href="../04-%20Southbound%20Interfaces/02-%20Mapping%20Policy.md" target="_blank">Mapping Policy</a> - A mapping policy defines how incoming JSON data (arriving at an operator node) should be
...
* <a href="./04-%20Unitfied%20Namespace.md" target="_blank">UNS</a> - Unified namespace policies are a way to help the user view the data in a hierarchical format; similar to
