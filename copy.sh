...
# known exact duplicate of secure network.md -> park for review instead of overwriting
...
# OpenHorizon deployment demo
if [ -d "deployments/OpenHorizon" ]; then
  mv -v deployments/OpenHorizon "$DEST_EXAMPLES_TRAINING"/
fi
