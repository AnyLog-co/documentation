...
Starting AnyLog from the command line is demonstrated in the section: [Starting an AnyLog Instance](../ORPHANS/x01-getting-started/starting%20an%20anylog%20instance.md).
...
The node dictionary is detailed in the [local dictionary](../17-%20Appendices/C-%20Reference%20Materials/dictionary.md#the-local-dictionary) section.
