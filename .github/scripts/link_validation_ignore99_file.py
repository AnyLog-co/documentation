...
def _has_99_prefix(path: Path, root: Path) -> bool:
    ...
    try:
        ...
        parts = path.parts
    return any(part.startswith("99-") or part == "HOWTO.md" or part == "README.md" for part in parts)
...
def main():
    ...
    parser.add_argument("root", nargs="?", default=ROOT_PATH, help="Root directory to scan (default: current dir)")
