...
For demo purposes, I'm using a query that consists of [increments function](../04%20queries.md#the-increment-function) and returns the data as a list of JSON values without statistics:
```sql
