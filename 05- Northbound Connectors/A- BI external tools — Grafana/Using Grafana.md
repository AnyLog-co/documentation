...
<<<<<<<< HEAD:08- Northbound Connectors/A- BI external tools — Grafana/Using Grafana.md
...
========
demo BI tool. However, directions for other BI tools, such as [Microsoft's PowerBI](04 Power BI Connector.md), can be found in our 
>>>>>>>> origin/pre-develop:08- Northbound Connectors/A- BI external tools — Office/03 Using Grafana.md
...
Detailed description of the **increment** query is available in the [increment section](../04%20queries.md#the-increment-function).
...
Comprehensive specifications for **include** and **extend** are provided in the [Query Options](../04%20queries.md#query-options) section.
...
Detailed description of the **period** query is available in the [period section](../04%20queries.md#the-period-function).
...
More information on increments and period types of queries are available in [queries and info requests](../04%20queries.md#optimized-time-series-data-queries).
