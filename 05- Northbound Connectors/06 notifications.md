...
* <a href="https://developers.google.com/workspace/chat/quickstart/webhooks" target="_blank">Google Hangouts</a>
...
<ol>
  ...
  <li>
    ...
    <table>
      <tr>
        <td align="center"><img src="/docs/imgs/notification_slack_your_app.png" height="75%" width="75%" /></td>
        <td align="center"><img src="/docs/imgs/notification_slack_manifest.png" height="75%" width="75%" /></td>
      </tr>
    </table>
  </li>
  <li>
    ...
    <br />
    <img src="/docs/imgs/notification_slack_workspace.png" height="50%" width="50%" />
  </li>
  <li>Press continue / next till the end.</li>
  <li>
    Select <i>Incoming Webhooks</i>.
    <br />
    <img src="/docs/imgs/notification_slack_webhook.png" height="50%" width="50%" />
  </li>
  <li>
    Enable Webhooks.
    <br />
    <img src="/docs/imgs/notification_slack_enable_webhooks.png" height="50%" width="50%" />
  </li>
  <li>
    At the bottom, add <i>Webhook</i> to the workspace.
    <br />
    <img src="/docs/imgs/notification_slack_create_webhook.png" height="50%" width="50%" />
  </li>
  <li>
    Select which channel in Slack to send messages to.
    <br />
    <img src="/docs/imgs/notification_slack_select_channel.png" height="50%" width="50%" />
  </li>
  <li>
    When done, you should see a <i>webhook</i> URL. This will be used as part of your REST request in AnyLog.
    <br />
    <img src="/docs/imgs/notification_slack_webhook_generated.png" height="50%" width="50%" />
  </li>
</ol>
...
### Slack Webhooks
AnyLog allows to send cURL requests the <a href="/docs/Querying-Data-Northbound/anylog-commands/#rest-command">>_rest_ command</a>. Since _Webhooks_ are 
...
<img src="/docs/imgs/notification_slack_messsage.png"  height="50%" width="50%" />
...
The `text` field in the body can be any alert message. Use this command directly, in a scheduled task, or as the action in a <a href="/docs/Monitoring-Operations/node-monitoring/#streaming-conditions-real-time-alerts">>streaming condition</a>.
