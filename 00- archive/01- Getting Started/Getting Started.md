...
- 2026-07-02 | Unified from: 01- Getting Started/Getting Started.md, 
               ...
               Hyperlinks re-pointed to numeric doc tree, however there are a few outstanding issues: 
                 ...
                 2. **"Using EdgeX" link is ambiguous.** Two candidate targets exist in the numbered tree — 
                    `03- Installation & Deployment/C- Cloud & Edge Deployments/EdgeX - complete example.md` and 
...
<!-- LINK NEEDS TARGET: legacy "Using EdgeX" link is ambiguous between ../03- Installation & Deployment/C- Cloud & Edge Deployments/EdgeX - complete example.md and ../07- Connectors & Integrations/B- Southbound Interfaces/Using MQTT (EdgeX).md. Pick one (or link both) before publishing. -->
