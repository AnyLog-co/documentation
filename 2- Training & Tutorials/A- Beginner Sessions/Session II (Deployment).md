...
* The [deploying_node](../../ORPHANS/x09-examples-training/deployments/deploying%20node.md) document is a guide to deploy a network using a questionnaire
that to generate the config file.
* The [Network Setup](../../ORPHANS/x09-examples-training/advanced/Network%20Setup.md) document is a step by step guide to deploy an AnyLog network without 
...
| --------------------------------------------------- | ------------- |-------------- |
| [AnyLog](https://www.anylog.co/)                    | The AnyLog software package on each node.  | [Deploying a Node](../../ORPHANS/x09-examples-training/deployments/deploying%20node.md) |
...
Using the questionnaire is detailed in the [deploying_node](../../ORPHANS/x09-examples-training/deployments/deploying%20node.md) document.

For **AWS deployment**, read the [AWS setup](../Tips%20&%20Tricks/configure_AWS) document.
