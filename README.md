...
* **01- Getting Started**
  * [deployment-scripts](01- Getting Started/03 deployment-scripts.md)
  * [Executable](01- Getting Started/04 Executable.md)
  * [Getting Started](01-%20Getting%20Started/Getting%20Started.md)
  * [install-ova](01- Getting Started/05 Installing the VM OVA.md)
  * [installing-anylog](01- Getting Started/05 Installing Anylog.md)
  * [Overview](01- Getting Started/anylog as a serivceOverview.md)
  * [Prerequisite](01- Getting Started/02 Prerequisite.md)
  * [Quick Deployment Guide](01-%20Getting%20Started/Quick%20Deployment%20Guide.md)
  * [quick-start](01-%20Getting%20Started/030%20Quick%20Deployment%20Guide.md)
  * [Service](01- Getting Started/042 Configure as a Service.md)
...
* **04- Core Concepts**
  ...
  * [Policies](04- Core Concepts/01 Policies.md)
  * **A- Agent Services**
    * [Metadata Manager](04-%20Core%20Concepts/A-%20Agent%20Services/Metadata%20Manager.md)
    * [Operator](04- Core Concepts/A- Agent Services/01 Operator.md)
    * [Publisher](04- Core Concepts/A- Agent Services/03 Publisher.md)
    * [Query](04- Core Concepts/A- Agent Services/02 Query.md)
  * **B- Network-Services**
...
* **06- Data Management**
  ...
  * **B- Query & Aggregations**
    * [Aggregations](06- Data Management/B- Query & Aggregations/02 Aggregations.md)
    ...
    * [Queries](06- Data Management/B- Query & Aggregations/01 Queries.md)
...
* **07- Southbound Interfaces**
  * [data-ingestion](07- Southbound Interfaces/02 data-ingestion.md)
  * [live-data-generator](07- Southbound Interfaces/04 live-data-generator.md)
  * [node-monitoring](07- Southbound Interfaces/03 node-monitoring.md)
  * [southbound-overview](07- Southbound Interfaces/01 southbound-overview.md)
  ...
  * **A- Direct - Built-in connectors (protocols AnyLog natively accepts from devices)**
    * [DNP3](07- Southbound Interfaces/A- Direct - Built-in connectors (protocols AnyLog natively accepts from devices)/06 DNP3.md)
    ...
    * [MODBUS](07- Southbound Interfaces/A- Direct - Built-in connectors (protocols AnyLog natively accepts from devices)/02 MODBUS.md)
    ...
    * [video-streaming](07- Southbound Interfaces/A- Direct - Built-in connectors (protocols AnyLog natively accepts from devices)/07 video-streaming.md)
  * **B- Third-party applications — external apps that push data to AnyLog**
    ...
    * [edgex](09- Integrations/B- Messages Brokers/edgex integration.md)
    * [kubearmor](07- Southbound Interfaces/B- Third-party applications — external apps that push data to AnyLog/01 kubearmor.md)
    * [node-red](07- Southbound Interfaces/B- Third-party applications — external apps that push data to AnyLog/02 node-red.md)
    * [telegraf](07- Southbound Interfaces/B- Third-party applications — external apps that push data to AnyLog/04 telegraf.md)
  ...
  * **C- REST**
    * [mapping-policies](07- Southbound Interfaces/C- REST/02 mapping-policies.md)
    * [Using REST](07-%20Southbound%20Interfaces/C-%20REST/Using%20REST.md)
* **08- Northbound Connectors**
  * [northbound-overview](08- Northbound Connectors/01 northbound-overview.md)
  * [notifications](08- Northbound Connectors/06 notifications.md)
  * [postgres-connector](08- Northbound Connectors/03 postgres-connector.md)
  * [Postman Integration](08-%20Northbound%20Connectors/Postman%20Integration.md)
  * [PowerBI](08- Northbound Connectors/A- BI external tools — use AnyLog's REST (or gRPC) API as their data source`/PowerBI.md)
  * [Qlik](08- Northbound Connectors/A- BI external tools — use AnyLog's REST (or gRPC) API as their data source`/02 Qlik How to.md)
  * [queries](08- Northbound Connectors/04 queries.md)
  * [sql-setup](08- Northbound Connectors/05 sql-setup.md)
...
* **09- Integrations**
  ...
  * **C- Deployment tools**
    * [Barbara](09- Integrations/C- Deployment tools/02 Barbara.md)
