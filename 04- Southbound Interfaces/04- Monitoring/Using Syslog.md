...
---
<<<<<<<< HEAD:07- Southbound Interfaces/C- Direct Connectors Monitoring/Using Syslog.md
<!--
## Changelog
...
receiving log messages across a network. AnyLog can act as a syslog receiver, accepting messages from any host that 
supports TCP syslog output, storing them as queryable time-series data alongside all other data in the network.
>>>>>>>> origin/pre-develop:07- Southbound Interfaces/B- Third-party applications — external apps that push data to AnyLog/062 Ingesting Syslog msgs.md
