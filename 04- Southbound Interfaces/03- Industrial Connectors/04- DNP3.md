...
For a full example combining this with a scripted deployment and a reusable mapping policy (rather than an inline `map` array), see [Deploying a DNP3 Connector via Script](01-%20DNP3%20Deploying%20Connector%20via%20Script.md).
...
Generate a test CA chain first — see [DNP3 TLS Test Certificates](./04-1%20/01-%20DNP3%20-%20TLS%20test%20certificates
.md) for the full script and instructions. Run it in a working directory of your own, outside this repository:
