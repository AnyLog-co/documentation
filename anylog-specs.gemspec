...
Gem::Specification.new do |spec|
  spec.name          = "anylog-specs"
  spec.version       = "1.0.0"
  spec.authors       = ["Ori Shadmon"]
  spec.email         = ["ori@anylog.co"]

  spec.summary       = %q{anylog documentation}
  spec.homepage      = "https://github.com/AnyLog-co/anylog.github.io"
  spec.license       = "MIT"
  spec.metadata      = {
    "bug_tracker_uri"   => "https://github.com/AnyLog-co/anylog.github.io/issues",
    "documentation_uri" => "https://anylog.github.io",
    "source_code_uri"   => "https://github.com/AnyLog-co/anylog.github.io",
  }
