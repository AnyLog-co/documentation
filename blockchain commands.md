...
```blockchain update dbms [path and file name]``` – add the policies in the named file (or in the blockchain file, if a named file is not provided) to the local dbms that maintains the blockchain data.  
