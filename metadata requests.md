...
An overview on the global metadata layer is provided in [Managing Metadata](/docs/metadata-management/#managing-metadata).  
...
The section [Adding Data](/docs/adding-data/#adding-data-to-nodes-in-the-network) 
details how watch-directories are used and how data is added to nodes in the network using REST.       
The section [Using MQTT Broker](/docs/message-broker/#using-a-message-broker) details how data is added using a broker.  
...
Note: Details on the TSD tables is available at [Managing Data files](/docs/managing-data-files-status/#managing-data-files).
