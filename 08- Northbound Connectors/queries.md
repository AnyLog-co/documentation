...
Before querying, you'll usually want to know what data actually exists across the network — which tables are
registered, which nodes host them, and their columns/types. See
[Databases & Tables — Discovering what exists](../02-%20Training%20%26%20Tutorials/Databases%20%26%20Tables.md#discovering-what-exists)
for `get virtual tables` and `get data nodes`, and
[...Inspecting and monitoring](../02-%20Training%20%26%20Tutorials/Databases%20%26%20Tables.md#get-columns--schema-of-a-table)
for `get columns`.
