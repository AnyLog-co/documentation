...
- 2026-07-02 | Unified from: 01- Getting Started/01- Getting Started.md, 
               ...
               Hyperlinks re-pointed to numeric doc tree, however there are a few outstanding issues: 
                 1. **Master Node setup page has no numeric target.** The old link (`master node.md`) pointed to a 
                    ...
                    that this content lives inside `02- Installation & Deployment/A- Deployment Options/Node Configuration.md` 
                 ...
                 2. **"Using EdgeX" link is ambiguous.** Two candidate targets exist in the numbered tree — 
                    `02- Installation & Deployment/C- Cloud & Edge Deployments/EdgeX - complete example.md` and 
...
<!-- LINK NEEDS TARGET: legacy docs reference a dedicated "Using a Master Node" page (old path: master node.md). No equivalent file currently exists under the numeric tree. Closest candidates: ../02- Installation & Deployment/A- Deployment Options/Node Configuration.md or Deploying a Node.md — confirm which (or create a new page) before publishing. -->
...
<!-- LINK NEEDS TARGET: legacy "Using EdgeX" link is ambiguous between ../02- Installation & Deployment/C- Cloud & Edge Deployments/EdgeX - complete example.md and ../07- Connectors & Integrations/B- Southbound Interfaces/Using MQTT (EdgeX).md. Pick one (or link both) before publishing. -->
