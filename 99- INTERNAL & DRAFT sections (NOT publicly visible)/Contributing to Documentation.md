...
# <!--title:--> Contributing to product documentation 
### <!--description:--> guide to updating documentation  
### File owner: Ori Shadmon 
layout: page
...
### 📜 Change Log
 ...
 |----------------|----------------|-----------------------------|------------|
 | 2026-07-10     | Eric Aquaronne | Added OAuth2 authentication | 2.0.2606   |
...
using Jekyll, replacing raw GitHub repo access with a structured, navigable site comparable to EdgeX or ReadTheDocs.
...
You need to add front matter upstream (this site recognizes the `title` and `description` fields)
Evey file **must** contain a header change log so when reading it one knows when changed / who did it / what date and Anylog version,  use the format below
| 
...
layout: page
file owner: your name
---
### 📜 Change Log
   **Date**       | **Name**       | **Version**                 | **Change** |
 |----------------|----------------|-----------------------------|------------|
 | 2026-07-10     | Mr B           | Added this                  | 2.0.2606   |
 | 2026-07-08     | Mr A.          | initial file                | 1.5.2510   |
 | |
