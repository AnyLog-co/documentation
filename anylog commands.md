...
| reset self IP | Identify an IP to be used when sender and receiver are the same node. Details are available at [Network Configuration](/docs/network-configuration/#reset-self-messaging).|
...
| [get processes](®#the-get-processes-command)                                                                                          | The list of background processes. More details are available in [background processes](/docs/background-processes/).                                                                                                                            |
