...
1. (Optional) Update the configurations before deployment 
   ...
   3. In [anylog_operator1.env](https://github.com/AnyLog-co/deployments/tree/master/docker-compose/demo-cluster-deployment/envs/anylog_operator1.env) & [https://github.com/AnyLog-co/deployments/tree/master/docker-compose/demo-cluster-deployment/anyolog_operator2.env](envs/anylog_operator2.env) update
      * NODE_NAME
      * COMPANY_NAME
      * _DB_USER_ & _DB_PASSWORD_ if using PostgreSQL & changed its credentials
