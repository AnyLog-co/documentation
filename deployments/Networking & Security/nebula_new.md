...
2024-10-16 00:45:06.814643 351.245 

{"Statistics":[{"Count": 11,
                "Time":"00:00:00",
                "Nodes": 1}]}EL anylog-query +> run client () sql new_company format=table "select timestamp, value FROM rand_data WHERE timestamp >= NOW() - 15 seconds;" 
[5]
EL anylog-query +> 
timestamp                  value
-------------------------- ------- 
