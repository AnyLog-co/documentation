...
Nodes in the network are configured to receive messages through _TCP_ (usually used between nodes), _REST_ and [message broker](../../ORPHANS/x02-cli/x03-network-services/message%20broker.md). 
