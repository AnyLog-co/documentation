...
Each node in the AnyLog Network can be configured as a data consumer. Kafka serves as a [message broker](../../09-%20Connectors%20&%20Integrations/C-%20Messages%20Brokers/Message%20Broker%20Setup.md#using-a-message-broker) that transfers data to the network nodes. The flow of data from a Kafka instance to the network is detailed in [The Southbound Connectors Diagram](../../06-%20Data%20Management/A-%20Data%20Ingestion/Adding%20Data.md#the-southbound-connectors-diagram).
...
Details on the topic declaration and mapping instructions are available in [Message Broker Setup](../../09-%20Connectors%20&%20Integrations/C-%20Messages%20Brokers/Message%20Broker%20Setup.md#the-topic-params).
...
|---|---|
| [get processes](../../06-%20Data%20Management/D-%20Monitoring%20&%20Alerts/Monitoring%20Nodes.md#the-get-processes-command) | Background processes to determine if Kafka is enabled |
| [get msg client](../../06-%20Data%20Management/D-%20Monitoring%20&%20Alerts/Monitoring%20Calls.md#get-msg-clients) | Subscriptions to brokers and data consumed from Kafka instances |
| [get streaming](../../06-%20Data%20Management/D-%20Monitoring%20&%20Alerts/Monitoring%20Calls.md#get-streaming) | Data consumed from brokers associated to dbms tables |
| [get operator](../../06-%20Data%20Management/D-%20Monitoring%20&%20Alerts/Monitoring%20Calls.md#get-operator) | Statistics on ingestion of data to database tables |
...
> [Mapping Data to Tables](../../06-%20Data%20Management/A-%20Data%20Ingestion/Mapping%20Data%20to%20Tables.md) defines how to interpret incoming data from Kafka — the same way it works for MQTT and REST POST requests.
