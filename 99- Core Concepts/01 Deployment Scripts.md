...
- 2026-07-12 | 
    - Restructured around 4 sections: the AnyLog/deployment-scripts split, repo structure (top-level only —
      see 11- Extended Services for the file-by-file tree), what happens at startup + local_script.al, and the
    ...
    - Intentionally kept at "general sense" depth — internals, policy/script mechanics, process vs thread, and
      the full build/runtime env-var matrix live in 11- Extended Services instead.
- 2026-07-12 (rev 2) |
