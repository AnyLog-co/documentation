...
AL Operator_3 >
```
Details are available [here](../ORPHANS/x02-cli/anylog%20commands.md#set-node-name).
...
### The "if" command
Scripts can include conditional statements. Details are available in the [Conditional execution](../ORPHANS/x02-cli/anylog%20commands.md#conditional-execution) section.
