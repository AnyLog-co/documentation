...
description: ""
layout: page
source_path: "05 Blockchain Commands.md"
---
<!---
### 📜 Change Log
...
1. Connecting to the blockchain platform. The following command connects to the blockchain platform, Details are available [here](../../ORPHANS/x04-southbound-services/using%20ethereum.md#connecting-to-ethereum). 
```anylog
...
3. [Configuring synchronization](../../ORPHANS/x04-southbound-services/blockchain%20configuration.md) against the blockchain platform.  
...
| blockchain      | A connected blockchain platform (i.e. Ethereum, and see Ethereum connection info in [this doc](../../ORPHANS/x04-southbound-services/using%20ethereum.md#using-ethereum-as-a-global-metadata-platform)).                                                                         |
