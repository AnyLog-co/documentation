 ...
 **Date**   | **Name**      | **Change**         | **Version** |
 ...
 | 2026-07-25 | Ori Shadmon | Split from the general overlay-networking concept doc (now
   **[Overlay Networking](F-%20Overlay%20Networking.md)**) — this file is Nebula-specific. Kept the Docker-based
...
example for AnyLog deployments; see **[Overlay Networking](F-%20Overlay%20Networking.md)** for the general concept
this fits into.
...
* **Certificate Authority (CA)** — two files: a CA certificate (distributed to and trusted by every host) and its
  ...
  **[Certificate Authority](overlay-certificate-authority.md)** for why this is a separate concern from the
...
**[Network Processing](B-%20Network%20Processing.md)** for the full `NIC_TYPE`/binding reference — this is just the
