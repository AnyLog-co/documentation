...
## Sending Data
[send_data.py](../../ORPHANS/x09-examples-training/Sample%20Python%20Scripts/data/send_data.py) is a python script to send timestamp & value data (see the example below) into AnyLog node via _REST_ (_POST_ or _PUT_)  or _MQTT_ publish. 
```json
{
...
### Example
[Python example](../../ORPHANS/x09-examples-training/Sample%20Python%20Scripts/data/send_data.py) is an interactive tool to publish data into AnyLog via _REST_ or _MQTT_
