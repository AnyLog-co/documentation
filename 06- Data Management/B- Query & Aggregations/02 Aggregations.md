...
The encoding is represented by a new data set associated to a new schema. The table name with the encoding format is using the original table name, prefixed by the encoding type. 
