...
The process of deploying AnyLog as a service is built on the information in [Executable.md](05 Executable Deployment.md), which 
explains how to deploy AnyLog executable. 

## Prepare Machine for AnyLog as Service 
1. Repeat steps 1-6 in [Executable.md](05 Executable Deployment.md)
