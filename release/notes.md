...
1. New options for issuing AnyLog commands via REST: 
    a) [Specifying commands in the message URL](../using%20rest.md#specifying-commands-in-the-message-url)
    b) [Specifying commands in the message body](../using%20rest.md#specifying-commands-in-the-message-body)
