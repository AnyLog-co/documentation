...
[Overlay Networking](03 overlay-network.md) for a full worked example.
...
`nebula1`) rather than a physical NIC — see [Overlay Networking](03 overlay-network.md) for how that interface gets 
created.
