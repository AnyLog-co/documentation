...
![extensions → add-ons](/assets/external-docs/imgs/googledrive_install_step1.png)


2. In the search bar look for "Two Minute Reports" & double click it
![software list](/assets/external-docs/imgs/googledrive_install_step2.png)


3. Install the add-on to your Google Sheets & press "continue"  

| ![install screen 1](/assets/external-docs/imgs/googledrive_install_step3a.png) | ![install screen 2](/assets/external-docs/imgs/googledrive_install_step3b.png) |
| --- | --- |

4. Google Requires users to confirm - click on the user you'd like to install the application on & press "Allow" 

| ![confirm account](/assets/external-docs/imgs/googledrive_install_step4a.png) | ![grant permission](/assets/external-docs/imgs/googledrive_install_step4b.png) | 
| --- | --- |
...
![add](/assets/external-docs/imgs/googledrive_execute_step2.png)
...
For demo purposes, I'm using a query that consists of [increments function](/docs/queries/#the-increment-function) and returns the data as a list of JSON values without statistics:
```sql
...
| ![type](/assets/external-docs/imgs/googledrive_execute_step3a.png) | ![form](/assets/external-docs/imgs/googledrive_execute_step3b.png) |
| --- | --- |

4. Once the form is complete, test and save the changes - this will validate that the request is valid

| ![test & save](/assets/external-docs/imgs/googledrive_execute_step4a.png) | ![confirm](/assets/external-docs/imgs/googledrive_execute_step4b.png) | 
| --- | --- |

5. In menu, goto _Data Queries_

![menu options](/assets/external-docs/imgs/googledrive_execute_step5.png)


6. Press _Add+_ to create a new Query Form

![add query form](/assets/external-docs/imgs/googledrive_execute_step6.png)

7. Fill-out the form, setting _Data Source_ to be the same as the the one created earlier & press "Run Query"

![complete form](/assets/external-docs/imgs/googledrive_execute_step7.png)
...
![table & graph](/assets/external-docs/imgs/googledrive_final_result.png)
