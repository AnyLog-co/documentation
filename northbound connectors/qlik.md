...
<img src="/assets/external-docs/imgs/qlik1.png" height=50% width=50% alt="source options" />
4. We use a standard _REST_
<img src="/assets/external-docs/imgs/qlik2.png" height=50% width=50% alt="source options" />
...
## Increments Data 
The [increments function](/docs/queries/#the-increment-function) is used to segment time-series data into fixed, contiguous 
...
<img src="/assets/external-docs/imgs/qlik5.png" height=50% width=50% />
...
2. In the headers section add the following params: 
    ...
    * **destination**: `network`
<img src="/assets/external-docs/imgs/qlik6.png" height=50% width=50% />

3. Validate the data and continue 
<img src="/assets/external-docs/imgs/qlik7_increments.png" height=50% width=50% />

4. Create a new Analytics
<img src="/assets/external-docs/imgs/qlik8.png" height=50% width=50% />

5. Create a graph based on the given Dimensions 
<img src="/assets/external-docs/imgs/qlik9_increments.png" height=50% width=50% />

## Period Data 
The [period function](/docs/queries/#the-period-function) finds the first occurrence of data before or at a specified 
...
3. Validate the data and continue 
<img src="/assets/external-docs/imgs/qlik7_period.png" height=50% width=50% />

4. Create a new Analytics
<img src="/assets/external-docs/imgs/qlik8.png" height=50% width=50% />

5. Create a graph based on the given Dimensions
<img src="/assets/external-docs/imgs/qlik9_period.png" height=50% width=50% />
